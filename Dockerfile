...
RUN set -ex \
 ...
 && (cd arctic-sea && mvn -B -e -ff -D maven.javadoc.skip=true -D maven.test.skip=true -P no-download install) \
 && (cd javaPS && mvn -B -e -ff -D maven.javadoc.skip=true -D maven.test.skip=true -P no-download install) \
 && mvn -B -e -ff -D maven.javadoc.skip=true -D maven.test.skip=true -P no-download install
